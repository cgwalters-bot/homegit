...
sources:
  ...
  - repo: bootc-dev/actions
    path: AGENTS.md
    sha: 9f005b9713e7a2eb807293e9815bf791432d9dfd
  - repo: bootc-dev/actions
    path: REVIEW.md
...
> a signoff."
> — bootc-dev/actions AGENTS.md (9f005b9713e7), "Signed-off-by"
...
> knowledge"
> — bootc-dev/actions AGENTS.md (9f005b9713e7), "Attribution and AI disclosure"
...
> — bootc-dev/actions AGENTS.md (9f005b9713e7), "Large changes"
...
> — bootc-dev/actions AGENTS.md (9f005b9713e7), "Commit messages and text"

> "Generally, just restate the commit message."
> — bootc-dev/actions REVIEW.md (3068dd57b2c3), "PR Descriptions"
...
> — bootc-dev/actions REVIEW.md (3068dd57b2c3), "Before Merge"
