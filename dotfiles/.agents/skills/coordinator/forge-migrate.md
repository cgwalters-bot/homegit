...
Final report: one line per item with the item, the result (forge PR URL / question issue URL / skipped + reason), tests run, and anything cgwalters must decide.
